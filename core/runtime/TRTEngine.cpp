...
std::vector<std::string> TRTEngine::serialize() const {
  // Serialize TensorRT engine
  auto serialized_trt_engine = this->cuda_engine->serialize();
  ...
  serialize_info[NAME_IDX] = this->name;
  serialize_info[DEVICE_IDX] = serialize_device(this->device_info);
